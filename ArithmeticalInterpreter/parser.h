...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOKEN_END || tok == token::TOKEN_CLASS || tok == token::TOKEN_MINUS || tok == token::TOKEN_PLUS || tok == token::TOKEN_DIV || tok == token::TOKEN_MUL || tok == token::TOKEN_LPAREN || tok == token::TOKEN_RPAREN || tok == token::TOKEN_ASSIGN || tok == token::TOKEN_PUBLIC || tok == token::TOKEN_STATIC || tok == token::TOKEN_VOID || tok == token::TOKEN_MAIN || tok == token::TOKEN_PRINT || tok == token::TOKEN_LINE_END || tok == token::TOKEN_LBRACKET || tok == token::TOKEN_RBRACKET || tok == token::TOKEN_INT);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      {
        return symbol_type (token::TOKEN_STATIC, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_STATIC, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOKEN_MAIN, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_MAIN, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LINE_END (location_type l)
      {
        return symbol_type (token::TOKEN_LINE_END, std::move (l));
      }
#else
      static
      symbol_type
      make_LINE_END (const location_type& l)
      {
        return symbol_type (token::TOKEN_LINE_END, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
