...
#line 85 "parser.y"
                         {
    if (driver.ContainsVariable(yystack_[1].value.as < std::string > ())) {
...
#undef YYCASE_
  ...
  {
  "\"EOF\"", "error", "$undefined", "\"class\"", "\"-\"", "\"+\"",
  "\"/\"", "\"*\"", "\"(\"", "\")\"", "\"=\"", "\"public\"", "\"static\"",
  "\"void\"", "\"main\"", "\"System.out.println\"", "\";\"", "\"{\"",
  "\"}\"", "\"int\"", "\"identifier\"", "\"number\"", "$accept",
  "expression", "main_class", "statement_list", "statement", YY_NULLPTR
  };
